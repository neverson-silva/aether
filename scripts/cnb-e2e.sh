...
BUILDER="${AETHER_CNB_BUILDER:-127.0.0.1:5000/builder:node-spa}"
...
bash builders/build-builder.sh >/dev/null 2>&1 || true
...
run_case node-simple testdata/cnb/node-simple 39001 "aether node fixture"
run_case nestjs testdata/cnb/nestjs 39002 "aether nestjs fixture"
run_case react-vite testdata/cnb/react-vite 39003 "react" 1
run_case vue-vite testdata/cnb/vue-vite 39004 "vue" 1
run_case angular testdata/cnb/angular 39005 "AngMin" 1
run_case pnpm-node testdata/cnb/pnpm-node 39006 "aether pnpm fixture"

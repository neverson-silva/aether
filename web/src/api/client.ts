...
export function getServer(): string {
  // Sempre same-origin: em dev o Vite faz o proxy de /api para o
  // VITE_API_TARGET (vite.config.ts); em produção o próprio backend serve o
  // SPA. Assim o cookie de auth funciona em qualquer browser, sem CORS.
  return "";
}

          ...
          <>
            ...
            {running ? (
              <Button
                ...
                onClick={() =>
                  down.mutate(id, {
                    onSuccess: () => toast("Stack stopped"),
                    onError: (e) => toast(e instanceof Error ? e.message : "failed to stop", "error"),
                  })
                }
              >
                Stop
              ...
              <Button
                ...
                onClick={() =>
                  up.mutate(id, {
                    onSuccess: () => toast("Stack starting"),
                    onError: (e) => toast(e instanceof Error ? e.message : "failed to start", "error"),
                  })
                }
              >
                Start

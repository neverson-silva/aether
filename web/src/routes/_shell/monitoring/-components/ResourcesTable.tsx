              ...
              return (
                ...
                >
                  ...
                  <td className="py-2 px-2">
                    <span className={cn("px-2 py-0.5 rounded border font-label-caps text-label-caps", OWNER_BADGE[r.owner])}>
                      {OWNER_LABEL[r.owner]}
                    </span>
                  </td>
                  <td className="py-2 px-2">
                    <div className="flex items-center gap-2">
                      <span className={cn("w-2 h-2 rounded-full inline-block", STATE_DOT[r.state] ?? "bg-outline")} />

  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span className="material-symbols-outlined text-[16px] text-on-surface-variant transition-transform" style={{ transform: open ? "rotate(180deg)" : undefined }}>expand_more</span>
      </button>
          ...
          <div className="max-h-56 overflow-y-auto py-1 sidebar-scroll">
            ...
            {filtered.map((o, i) => (
              ...
              >
                ...
                {o.value === value && <span className="material-symbols-outlined text-[16px] text-primary shrink-0">check</span>}
              </button>
            ))}
          </div>
        </div>

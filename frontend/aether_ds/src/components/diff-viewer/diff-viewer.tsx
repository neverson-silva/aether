      ...
      <header className="flex items-center justify-between border-b border-border bg-surface-container-low/80 px-3 py-2">
        ...
        {collapseContext ? (
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-body-sm text-muted-foreground outline-none transition-colors hover:bg-surface-container focus-visible:ring-2 focus-visible:ring-ring"
          >

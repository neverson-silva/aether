    ...
    >
      {sidebar ? (
        ...
        >
          ...
          />
          <span
            className={`pointer-events-none absolute -right-0.5 top-1/2 z-0 h-12 w-1 -translate-y-1/2 rounded-full transition-[background-color,height] duration-200 ${dragging ? "h-16 bg-primary" : "bg-border"}`}
            aria-hidden="true"
          />
        </aside>
      ) : null}

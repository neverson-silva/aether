...
const link = tv({
  base: "inline-flex items-center gap-1 font-semibold underline-offset-4 transition-[color,background-color,transform] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring active:scale-[0.985]",
  variants: {
    tone: {
...
export function Link({
  ...
  return (
    ...
    >
      {children}
      {external ? (
        <span className="text-label-caps" aria-hidden="true">
          ↗
        </span>
      ) : null}
    </a>

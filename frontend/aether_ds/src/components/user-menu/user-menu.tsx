...
export function UserMenu({
  ...
  return (
    <Menu.Root>
      <Menu.Trigger className="flex items-center gap-2 rounded-xl px-2 py-1.5 text-left outline-none transition-[background-color,transform] duration-150 hover:bg-surface-container focus-visible:ring-2 focus-visible:ring-primary active:scale-[0.985]">
      ...
      <Menu.Portal>
        <Menu.Positioner className="z-50" sideOffset={6} align="end">
          <Menu.Popup className="min-w-64 rounded-2xl border border-border bg-surface-popover p-1.5 text-foreground shadow-xl outline-none data-[starting-style]:scale-95 data-[starting-style]:opacity-0 data-[ending-style]:scale-95 data-[ending-style]:opacity-0 transition-[transform,opacity] duration-150">
            ...
            <Menu.Item
              onClick={onProfile}
              className="cursor-pointer rounded-xl px-3 py-2 text-body-sm outline-none transition-colors data-[highlighted]:bg-surface-container"
            >
              Profile settings
            </Menu.Item>
            <Menu.Item
              onClick={onSignOut}
              className="cursor-pointer rounded-xl px-3 py-2 text-body-sm text-destructive outline-none transition-colors data-[highlighted]:bg-surface-container"
            >
              Sign out
            </Menu.Item>
          </Menu.Popup>

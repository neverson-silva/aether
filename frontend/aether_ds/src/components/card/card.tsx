...
const card = tv({
  ...
  variants: {
    variant: {
      ...
      interactive:
        'border-border bg-surface-card transition-[background-color,border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-primary/50 hover:bg-surface-container hover:shadow-lg active:translate-y-0 active:scale-[0.995]',
      selectable:
      ...
      glass: 'border-glass-border bg-glass-bg shadow-sm backdrop-blur-md',

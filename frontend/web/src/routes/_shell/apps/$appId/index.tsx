...
import { z } from "zod";
import { Select } from "@aether/design-system";
...
import { BackupTab } from "@/routes/_shell/databases/$dbId/-components/BackupTab";
...
function AppDetail() {
  ...
  <div className="space-y-lg">
    ...
    <div id={`service-panel-${tab}`} role="tabpanel" aria-labelledby={`service-tab-${tab}`} tabIndex={0} className="min-w-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background">

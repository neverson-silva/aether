    ...
    <div className="flex flex-col h-full min-h-[320px]">
      ...
      <div className="flex items-center gap-sm flex-wrap px-md py-2 bg-[#0a0a0a] border-b border-[#1a1a1a]">
        ...
        <NativeSelect
          ...
          className="w-auto bg-surface-container-low font-mono text-[11px] text-foreground"
          options={[{ label: "All levels", value: "" }, { label: "error", value: "error" }, { label: "warn", value: "warn" }, { label: "info", value: "info" }, { label: "debug", value: "debug" }]}
        />
        <label className="flex items-center gap-1 cursor-pointer select-none">

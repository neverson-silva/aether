...
import { ArrowRight, ChartLine, ChatCircle, Code, Database, Play, Plus, Table, TerminalWindow, X } from "@phosphor-icons/react";
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-background overflow-hidden relative">
        <div className="h-12 border-b border-outline-variant flex items-center px-md justify-between bg-background z-10">
          ...
          <div className="flex items-center gap-sm">
            <Button size="sm" variant="secondary" onClick={() => setShowCreateTable(true)}>
              ...
              {tabs.map((t) => (
                ...
                >
                  ...
                  <span
                    ...
                    className="text-[14px] hover:text-error ml-1"
                  >

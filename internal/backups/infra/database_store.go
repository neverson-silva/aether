...
func (s *DatabaseStore) GetConfiguration(ctx context.Context, databaseID uuid.UUID) (*domain.BackupConfiguration, error) {
	row, err := s.q.GetBackupConfigurationByDatabase(ctx, databaseID)
	if err != nil {
...
func (s *DatabaseStore) UpsertConfiguration(ctx context.Context, cfg *domain.BackupConfiguration) (*domain.BackupConfiguration, error) {
	row, err := s.q.UpsertBackupConfiguration(ctx, gen.UpsertBackupConfigurationParams{
...
func (s *DatabaseStore) DeleteConfiguration(ctx context.Context, databaseID uuid.UUID) error {
	return mapErr(s.q.DeleteBackupConfiguration(ctx, databaseID))
}

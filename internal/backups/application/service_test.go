...
func (s *fakeStore) UpsertConfiguration(_ context.Context, cfg *domain.BackupConfiguration) (*domain.BackupConfiguration, error) {
	s.config = cfg
	return cfg, nil
}
...
func (s *fakeStore) ListQueuedJobs(_ context.Context, _ int) ([]domain.BackupJob, error) { return nil, nil }
...
func (s *fakeStore) ListQueuedRestoreJobs(_ context.Context, _ int) ([]domain.RestoreJob, error) { return nil, nil }
...
func (p *fakeProvider) Capabilities() storage.Capabilities { return storage.Capabilities{Streaming: true} }
...
func (q *memQueue) NewConsumer(_ context.Context, _, _, _ string) (queue.Consumer, error) { return nil, nil }
